...
export default function ConfigurationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setValue_float(initialValues.value_float);
    setValue_string(initialValues.value_string);
    setErrors({});
  };
  const validations = {
    key: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Configuration(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ConfigurationCreateForm")}
      {...rest}
    >
      <TextField
        label="Key"
