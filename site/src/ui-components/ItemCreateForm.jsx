...
export default function ItemCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPrice_eur(initialValues.price_eur);
    setPriority(initialValues.priority);
    setActive(initialValues.active);
    setWidth_mm(initialValues.width_mm);
    setHeight_mm(initialValues.height_mm);
    setLength_mm(initialValues.length_mm);
    setWeight_g(initialValues.weight_g);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
